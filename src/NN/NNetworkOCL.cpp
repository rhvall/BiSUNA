...
//        readOrWriteCLBuffer(cont->oclRt->queue, cont->inBuffer, cont->inBuffSize, ref); // readBuffer
...
//        readOrWriteCLBuffer(cont->oclRt->queue, cont->outBuffer, cont->outBuffSize, cont->outRef, false); // writeBuffer
...
//    readOrWriteCLBuffer(cont->oclRt->queue, cont->unmBuffer, sizeof(CLUnifiedNeuralModel), &localUNM, false); // writeBuffer
}
