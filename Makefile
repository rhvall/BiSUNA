...
ENVIRONMENTS=$(ENVPATH)ReinforcementEnvironment.cpp $(ENVPATH)MountainCar.cpp $(ENVPATH)DoubleCartPole.cpp $(ENVPATH)FunctionApproximation.cpp $(ENVPATH)Multiplexer.cpp $(ENVPATH)SingleCartPole.cpp $(ENVPATH)SymmetricEncryption.cpp $(ENVPATH)SymmetricEncryptionCPA.cpp
