...
-- stack install matplotlib streamly
...
figPlot indx ab name = line indx ab @@ [o2 "linewidth" 1] % options
    where titled = title name @@ [o2 "fontsize" 16]
          xLbl = xlabel "Generation" @@ [o2 "fontsize" 16]
          yLbl = ylabel "Score" @@ [o2 "fontsize" 16]
          sized = setSizeInches 8 5
          options = titled % xLbl % yLbl % sized % grid True
